import { j as jsxRuntimeExports, J as Je, a as je, S as Se, r as reactExports } from "../ssr.js";
import { I as ImageSlider, L as List } from "./List-DU-BYUjw.js";
import { F as FavoriteButton, C as CompareButton, P as PuppyCard } from "./Card-B4vz22uj.js";
import { L as Layout } from "./Layout-DdG4gm-d.js";
import { S as ShareButton } from "./ShareButton-CD6S_fyt.js";
import { S as SellerCard } from "./SellerCard-BiIkpi__.js";
...
import "events";
import "process";
import "./create-element-if-not-defined-CvWUKBFO.js";
...
function ReportModal({ show, onClose, puppySlug }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal, { show, onHide: handleClose, centered: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal.Header, { closeButton: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Modal.Title, { children: "Report This Listing" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Modal.Body, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { htmlFor: "reason", className: "form-label", children: [
        ...
        errors.reason && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "invalid-feedback", children: errors.reason })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal.Footer, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: processing ? "Submitting..." : "Submit Report"
          }
        )
      ] })
    ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-wrapper position-relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "golden-retriever py-7 py-md-5 py-xl-9", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-lg-8 col-xl-9", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-xl-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "top-picks-details", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex align-items-start justify-content-between mb-4", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(FavoriteButton, { sellerId: (_c = puppy.seller) == null ? void 0 : _c.id, puppyId: puppy.id, isFavorite: puppy.is_favorite }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CompareButton, { sellerId: (_d = puppy.seller) == null ? void 0 : _d.id, puppyId: puppy.id, isCompared: puppy.is_compared }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex align-items-center gap-2 mb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "../images/svgs/icon-map-pin.svg", alt: "map", width: "20", height: "20" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-0 ", children: `${(puppy == null ? void 0 : puppy.city) || ""}${((puppy == null ? void 0 : puppy.city) || "").length > 0 ? ", " : ""}${(puppy == null ? void 0 : puppy.state) || ""}` })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex align-items-center gap-2 mb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("img", { loading: "lazy", src: "/images/svgs/icon-paws-dark.svg", alt: "urpuppy-img", width: "20", height: "20" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-0", children: ((_f = (_e = puppy.breeds) == null ? void 0 : _e[0]) == null ? void 0 : _f.name) ?? "" })
                ] }) }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row mb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex align-items-center gap-2 mb-2", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-0 ", children: puppy.published_at })
                  ] }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex align-items-center gap-2 mb-2", children: [
            ...
            puppy.characteristics && ((_g = puppy.characteristics) == null ? void 0 : _g.length) > 0 || puppy.features && puppy.features.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-body", children: [
              puppy.characteristics && ((_h = puppy.characteristics) == null ? void 0 : _h.length) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "charlies-characteristics pb-3 border-bottom", children: [
              ...
              puppy.features && ((_i = puppy.features) == null ? void 0 : _i.length) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "charlies-features mt-3 pt-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h5", { className: "mb-3 pb-1 fs-5", children: [
                  puppy.name,
                  "’s Features"
                ] }),
            ...
            ((_j = puppy.seller) == null ? void 0 : _j.is_breeder) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card position-relative overflow-hidden border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-xl-4 d-flex align-items-lg-stretch", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Je, { href: `/breeders/${(_k = puppy.seller) == null ? void 0 : _k.slug}`, className: "trusted-breeders-img position-relative overflow-hidden w-100 text-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "object-fit-cover rounded-circle position-relative overflow-hidden", src: ((_l = puppy.seller) == null ? void 0 : _l.company_logo) ?? "", alt: ((_m = puppy.seller) == null ? void 0 : _m.kennel_name) ?? "company logo", width: "230", height: "230" }) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-xl-8 d-flex align-items-lg-stretch", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "trusted-breeders-details card-body ps-xl-0 pe-4 d-flex align-items-start justify-content-between gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Je, { href: `/breeders/${(_n = puppy.seller) == null ? void 0 : _n.slug}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("h6", { className: "btn-link fs-8 font-work-sans mb-6", children: "Offered By" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "company-details mb-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hstack gap-6 mb-6", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-0", children: ((_o = puppy.seller) == null ? void 0 : _o.kennel_name) || "N/A" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hstack gap-6 mb-6", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-0 fw-medium text-dark", children: "Address:" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-0", children: ((_p = puppy.seller) == null ? void 0 : _p.company_address) || "N/A" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hstack gap-6", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-0", children: ((_q = puppy.seller) == null ? void 0 : _q.company_established_on_label) || "N/A" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Je, { href: `/breeders/${(_r = puppy.seller) == null ? void 0 : _r.slug}`, className: "btn btn-outline-extralight border btn-white text-dark", children: "View More" })
              ] }) }) })
            ] }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-lg-4 col-xl-3", children: [
            puppy.seller && /* @__PURE__ */ jsxRuntimeExports.jsx(SellerCard, { seller: puppy.seller }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bringing-through-puppies bg-extralight py-7 py-md-5 py-xl-9", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "d-flex align-items-center justify-content-between mb-4 mb-lg-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mb-0", "data-aos": "fade-right", "data-aos-delay": "100", "data-aos-duration": "1000", children: [
          "Other ",
          (_s = puppy == null ? void 0 : puppy.breeds[0]) == null ? void 0 : _s.name,
          " Listing"
        ] }) }),
