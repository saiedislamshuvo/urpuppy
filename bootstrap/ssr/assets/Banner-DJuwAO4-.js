import { c as commonjsGlobal, b as requireReact, r as reactExports, q, R as React$1, j as jsxRuntimeExports, f as fe } from "../ssr.js";
import { S as SelectFilterInput, M as MobilePicker, B as BreedFilter } from "./BreedFilter-BrdOE-Xz.js";
import { G as GenericModal } from "./GenericModal-CnypUvLo.js";
import { S as StateFilter } from "./StateFilter-DdsKmfb1.js";
import { M as Modal } from "./Modal-hQlRrbra.js";
import "util";
import "stream";
import "path";
import "http";
...
const PriceFilter = ({ setPrice, range = [1, 1e4], mobile = false }) => {
  const { props } = q();
  const price_filter_range = props.price_filter_range;
  const [priceRange, setValues] = React$1.useState(
  ...
  const renderDirectRange = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
        display: "flex",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${mobile ? "w-100" : ""}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h6", { className: `font-work-sans ${mobile ? "mb-3" : "mb-0"}`, children: "Price Range" }),
      mobile ? renderDirectRange() : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dropdown", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dropdown-menu p-3", children: renderDirectRange() })
      ] })
    ] })
  ] });
};
const PriceFilter$1 = reactExports.memo(PriceFilter);
const AgeFilter = ({ setAge, range = [0, 18], mobile = false, defaultValue }) => {
  const { props } = q();
  const age_filter_range = props.age_filter_range;
  ...
  const [ageRange, setValues] = React$1.useState(() => {
    if ((defaultValue == null ? void 0 : defaultValue.value) && Array.isArray(defaultValue.value)) {
  ...
  const handleAgeChange = reactExports.useCallback((values) => {
    const sortedValues = [...values].sort((a, b) => a - b);
    setValues(sortedValues);
    const ageLabel = sortedValues[1] >= 18 ? `0 - 18 MONTHS+` : `${sortedValues[0]} - ${sortedValues[1]} MONTHS`;
    setAge((prev) => ({
      ...prev,
      age: {
        label: ageLabel,
  ...
  const renderTrack = reactExports.useCallback(({ props: props2, children }) => {
    const { ref, onMouseDown, onTouchStart, style, ...restProps } = props2;
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...restProps,
  ...
  const ageDisplay = reactExports.useMemo(() => {
    if (ageRange[1] >= 18) {
      return "0 - 18 MONTHS+";
    }
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: ageRange[1] >= 18 ? "18 Months+" : `${ageRange[1]} Months`
          }
        )
      ]
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${mobile ? "w-100" : ""}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h6", { className: `font-work-sans ${mobile ? "mb-3" : "mb-0"}`, children: "Age Range" }),
      mobile ? renderDirectRange() : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dropdown", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
...
const AgeFilter$1 = reactExports.memo(AgeFilter);
const SelectMobile = ({
  loadOptions,
  selectedItem,
  handleInputChange,
...
const GenderFilter = ({ setGender, defaultValue, mobile = false }) => {
...
const FilterBox = () => {
  ...
  const initialFilters = React$1.useMemo(() => {
    var _a, _b, _c, _d, _e, _f, _g, _h;
    let priceValue = [100, 4e3];
    if (((_a = payload == null ? void 0 : payload.filter) == null ? void 0 : _a.price) && Array.isArray(payload.filter.price)) {
      priceValue = [
        Math.max(1, Math.min(payload.filter.price[0], 4e3)),
        Math.max(1, Math.min(payload.filter.price[1], 4e3))
      ];
    }
    let ageValue = [0, 18];
    if (((_b = payload == null ? void 0 : payload.filter) == null ? void 0 : _b.age) && Array.isArray(payload.filter.age) && payload.filter.age.length === 2) {
    ...
    const ageLabel = ageValue[1] >= 18 ? "0 - 18 MONTHS+" : `${ageValue[0]} - ${ageValue[1]} MONTHS`;
    return {
      breed: { label: ((_c = payload == null ? void 0 : payload.filter) == null ? void 0 : _c.breed) ?? "e.g. (Breed)", value: ((_d = payload == null ? void 0 : payload.filter) == null ? void 0 : _d.breed) ?? "All" },
      gender: { label: ((_e = payload == null ? void 0 : payload.filter) == null ? void 0 : _e.gender) ?? "e.g. (Male)", value: ((_f = payload == null ? void 0 : payload.filter) == null ? void 0 : _f.gender) ?? "All" },
      age: { label: ageLabel, value: ageValue },
      price: { label: `$${priceValue[0].toLocaleString()} - $${priceValue[1] >= 4e3 ? "4,000+" : priceValue[1].toLocaleString()}`, value: priceValue },
  ...
  const renderFilterLabel = React$1.useCallback(() => {
  ...
  const renderDesktopFilters = React$1.useCallback(() => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid-filter d-none d-lg-block", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex align-items-center justify-content-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "breed d-flex gap-2 border-end align-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BreedFilter, { setBreed: setFilter, defaultValue: filter.breed }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sex d-flex gap-2 border-end align-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GenderFilter, { setGender: setFilter, defaultValue: filter.gender }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "age d-flex gap-2 border-end flex-shrink-0 align-items-center", style: { minWidth: "220px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AgeFilter$1, { setAge: setFilter, defaultValue: filter.age, mobile: false }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "price-range d-flex gap-2 border-end flex-shrink-0 align-items-center", style: { minWidth: "210px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(PriceFilter$1, { setPrice: setFilter, mobile: false }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "state d-flex gap-2 align-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StateFilter, { setState: setFilter, defaultValue: filter.state }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
  ...
  const renderMobileFilters = React$1.useCallback(() => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid-filter-mobile aos-init aos-animate d-grid d-lg-none", "data-aos": "fade-up", "data-aos-delay": "300", "data-aos-duration": "1000", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Modal,
      {
        ...
        style: { zIndex: 9999 },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal.Header, { className: "d-flex align-items-center justify-content-between border-bottom px-4 py-3 bg-white", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-work-sans mb-0", style: { color: "var(--bs-primary)" }, children: "Find Ur puppy" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal.Body, { className: "px-4 py-3", style: { backgroundColor: "#f5f5f0" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "breed d-flex gap-2 border-bottom py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BreedFilter, { setBreed: setFilter, defaultValue: filter.breed, mobile: true }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sex d-flex gap-2 border-bottom py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GenderFilter, { setGender: setFilter, defaultValue: filter.gender, mobile: true }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "age d-flex gap-2 border-bottom py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AgeFilter$1, { setAge: setFilter, defaultValue: filter.age, mobile: true }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "price-range d-flex gap-2 border-bottom py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PriceFilter$1, { setPrice: setFilter, mobile: true }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "state d-flex gap-2 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StateFilter, { setState: setFilter, defaultValue: filter.state, mobile: true }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Modal.Footer, { className: "border-top px-4 py-3", style: { backgroundColor: "#f5f5f0" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
...
const Banner = ({
  ...
  const displayHeader = header || (settings == null ? void 0 : settings.hero_title) || "Find Ur Perfect Puppy Today!";
  const displaySubheader = subheader || (settings == null ? void 0 : settings.hero_subtitle) || "Find Your Perfect Pup: Healthy, Happy Puppies from Trusted Breeders!";
  const displayBackground = backgroundImage || (settings == null ? void 0 : settings.hero_background) || "/images/banner-img/banner-bg.jpg";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      className: size == "lg" ? "z-30 hero-section position-relative d-flex align-items-center" : "hero-section position-relative d-flex align-items-center pt-11 pb-10",
      style: {
        backgroundImage: `url(${displayBackground})`
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: size == "lg" ? "container position-relative z-1" : "container position-relative z-1 mt-lg-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row justify-content-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-xl-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h1",
          {
