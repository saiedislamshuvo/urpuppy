            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex align-items-center gap-2", children: [
                  puppy.is_new ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "puppy-spotlight-img position-relative overflow-hidden d-block", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "badge text-bg-success", children: "NEW" }) }) : null,
                  puppy.state || ((_a = puppy.seller) == null ? void 0 : _a.short_state) || ((_b = puppy.seller) == null ? void 0 : _b.company_short_state) ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "badge text-bg-success", children: puppy.state || ((_c = puppy.seller) == null ? void 0 : _c.short_state) || ((_d = puppy.seller) == null ? void 0 : _d.company_short_state) }) : null
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex flex-column gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(FavoriteButton, { uniqueId: location + puppy.id, sellerId: (_e = puppy.seller) == null ? void 0 : _e.id, puppyId: puppy.id, isFavorite: puppy.is_favorite }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CompareButton, { uniqueId: location + puppy.id, sellerId: (_f = puppy.seller) == null ? void 0 : _f.id, puppyId: puppy.id, isCompared: puppy.is_compared })
                ] })
              ]
            }
          )
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex align-items-center gap-2 mb-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-0 text-truncate", children: (puppy == null ? void 0 : puppy.state) || ((_g = puppy.seller) == null ? void 0 : _g.address) })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex align-items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-0", children: ((_h = puppy.breeds[0]) == null ? void 0 : _h.name) ?? null })
              ] }) }),
