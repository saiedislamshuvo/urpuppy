...
import UserProfile from "./UserProfile-tGGXlK4c.js";
import MyPuppies from "./MyPuppies-BEVuNNXw.js";
import { B as Button } from "./Button-C_TFTgI3.js";
import { A as AlertDismissible } from "./AlertDismissible-D7qOQHSp.js";
import "util";
import "stream";
import "path";
import "http";
...
import "./MapInput-CiFWd45o.js";
import "./floating-ui.dom-CzygHDtM.js";
import "./PhoneNumberInput-CIZV4_bk.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-content", id: "pills-tabContent", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            !plan && !breeder_plan && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-body pb-0", children: (user == null ? void 0 : user.is_seller) && (user == null ? void 0 : user.profile_completed) || (user == null ? void 0 : user.is_breeder) && (user == null ? void 0 : user.profile_completed) || !(user == null ? void 0 : user.profile_completed) && ((user == null ? void 0 : user.is_seller) || (user == null ? void 0 : user.is_breeder)) ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row", children: [
              (user == null ? void 0 : user.is_seller) && (user == null ? void 0 : user.profile_completed) && /* @__PURE__ */ jsxRuntimeExports.jsx("h6", { className: "mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Je, { "aria-label": "Choose Plan", href: "/plans", method: "get", as: "button", className: "btn btn-primary", children: "Choose Plan" }) }),
              (user == null ? void 0 : user.is_breeder) && (user == null ? void 0 : user.profile_completed) && /* @__PURE__ */ jsxRuntimeExports.jsx("h6", { className: "mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Je, { "aria-label": "Choose Plan", href: "/plans/breeder", method: "get", as: "button", className: "btn btn-primary", children: "Choose Plan" }) }),
              !(user == null ? void 0 : user.profile_completed) && /* @__PURE__ */ jsxRuntimeExports.jsxs("h6", { className: "mb-4", children: [
                (user == null ? void 0 : user.is_breeder) && /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h6", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Je, { "aria-label": "Complete Profile", href: "/breeders/create", method: "get", as: "button", className: "btn btn-primary", children: "Complete Profile" }) }) }),
                (user == null ? void 0 : user.is_seller) && /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h6", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Je, { "aria-label": "Complete Profile", href: "/seller/create", method: "get", as: "button", className: "btn btn-primary", children: "Complete Profile" }) }) })
              ] })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row justify-content-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-lg-8 text-center py-12", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "h4 mb-3", children: "No subscription yet" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          tabIndex: 0,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-body pb-0", children: saved_searches.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row", children: saved_searches.map((saved_search, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-md-6 col-xx-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SavedSearchCard, { saved_search }, index) })) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row justify-content-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-lg-8 text-center py-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
