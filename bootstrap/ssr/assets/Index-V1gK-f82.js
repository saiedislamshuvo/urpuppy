...
import { B as BannerSlider, S as SmallBannerWithContent } from "./SmallBannerWithContent-BIfjpvZQ.js";
import { B as BreedFilter } from "./BreedFilter-BrdOE-Xz.js";
...
import "./pagination-UrZXYy2-.js";
import "./autoplay-B_dejtbc.js";
...
import "./GenericModal-CnypUvLo.js";
import "./Modal-hQlRrbra.js";
...
const Index = ({ breeds, letter_param = "A" }) => {
  ...
  const heroTitle = (settings == null ? void 0 : settings.breeds_hero_title) || "Siberian Husky: Your Winter Companion";
  const heroBackground = (settings == null ? void 0 : settings.breeds_hero_background) || "/images/breeds-slider/hero-inner-slider-1.jpg";
  const sectionTitle = (settings == null ? void 0 : settings.breeds_section_title) || "Choose your breeds";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(BannerSlider, { slidesPerView: 1, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SmallBannerWithContent, { title: heroTitle, background_image: heroBackground }, "1")
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "find-ur-breeds bg-extralight position-relative z-1 py-7 py-md-5 py-xl-9", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row justify-content-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-lg-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid-filter", "data-aos": "fade-up", "data-aos-delay": "200", "data-aos-duration": "1000", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex  justify-content-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "breed d-flex gap-2 align-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BreedFilter, { setBreed: setFilter }) }),
