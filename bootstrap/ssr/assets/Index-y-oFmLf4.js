import { j as jsxRuntimeExports, U, J as Je, r as reactExports } from "../ssr.js";
import Banner from "./Banner-jC4u_mX_.js";
...
import { P as PuppyCard, F as FavoriteButton, G as Gender } from "./Card-C5cxi3h3.js";
...
import { G as GenericModal } from "./GenericModal-BDVjRvTQ.js";
...
import { C as Card } from "./Card-BsMaxEic.js";
import "util";
import "stream";
import "path";
import "http";
...
import "events";
import "process";
import "./BreedFilter-DOc73LPo.js";
...
import "./StateFilter-DzoPEgjQ.js";
...
const PuppySpotlight = ({ puppy_spotlights }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "puppy-spotlight bg-extralight py-7 py-md-5 py-xl-9", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row align-items-stretch", children: puppy_spotlights.map((puppy) => /* @__PURE__ */ jsxRuntimeExports.jsx(PuppyCard, { location: "puppy-spotlight", className: "col-md-6 col-xl-3 mb-4 mb-xl-0", puppy, height: "310px" }, puppy.slug)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Je,
      {
...
const NewArrivals = ({ new_arrivals }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "new-arrivals py-5 ", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container py-xl-9", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex align-items-center justify-content-between mb-4 mb-lg-8", children: [
...
const BlogShowcase = ({ post_data }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "new-arrivals py-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container ", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex align-items-center justify-content-between mb-4 mb-lg-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mb-0", "data-aos": "fade-right", "data-aos-delay": "100", "data-aos-duration": "1000", children: "Latest Posts" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Je,
        {
          className: "btn btn-outline-extralight btn-white bg-white border text-dark d-none d-md-flex align-items-center gap-2",
          ...
          "data-aos-delay": "100",
          "data-aos-duration": "1000",
          children: "Discover new posts"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row", children: post_data.map((post, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { post }, post.slug)) })
  ] }) });
};
function Index({
  users,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-wrapper position-relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(BlogShowcase, { post_data }),
