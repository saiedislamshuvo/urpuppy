...
const Index = ({ puppies, states, breeds, has_search, seo_title, seo_description, url }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    ...
    !has_search ? /* @__PURE__ */ jsxRuntimeExports.jsx(Banner, { size: "md", header: defaultHeader, subheader: defaultSubheader, backgroundImage: defaultBackground }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Banner, { size: "md", header: `${puppies.total} Results`, subheader: "Below the search bar, you can filter your preferred breeds." }),
