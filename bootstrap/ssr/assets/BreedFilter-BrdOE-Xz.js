import { j as jsxRuntimeExports, r as reactExports, R as React, q } from "../ssr.js";
import { S as StateManagedSelect$1, A as AsyncPaginate } from "./index-Cs9ZHUfq.js";
...
const SelectFilterInput = ({ options, onChange, styles, ...props }) => {
...
function Cr() {
  if (Je)
    return te;
  Je = 1;
  var g = React, l = Symbol.for("react.element"), o = Symbol.for("react.fragment"), m = Object.prototype.hasOwnProperty, f = g.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, u = { key: true, ref: true, __self: true, __source: true };
  function E(R, p, k) {
...
function MobilePicker({ options, title = "value", setMobileFilter, value }) {
  const initialValue = (value == null ? void 0 : value.label) || (value == null ? void 0 : value.value) || (options && options.length > 0 ? options[0].label : "All");
  const [pickerValue, setPickerValue] = reactExports.useState({
    value: initialValue
  });
  React.useEffect(() => {
    const newValue = (value == null ? void 0 : value.label) || (value == null ? void 0 : value.value) || (options && options.length > 0 ? options[0].label : "All");
  ...
  const handleChange = (value2) => {
    ...
    setMobileFilter(value2);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Nr, { value: pickerValue, onChange: handleChange, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Nr.Column, { name: title, children: options == null ? void 0 : options.map(({ label, value: value2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Nr.Item, { value: label, children: label }, value2)) }, "key") });
}
...
const BreedFilter = ({ setBreed, title = "Breed", defaultValue, mobile = false }) => {
  const isMobile = q().props.isMobile;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-shrink-0 ${mobile ? '' : 'd-flex align-items-center'}", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/images/svgs/icon-breed.svg", alt: "Breed Icon" }) }),
