...
import { F as FavoriteButton, C as CompareButton, P as PuppyCard } from "./Card-Kjm6uc3j.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-wrapper position-relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "golden-retriever py-7 py-md-5 py-xl-9", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-lg-8 col-xl-9", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-xl-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "top-picks-details", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row mb-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-6 col-md-4 mb-6 border-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex align-items-center gap-2", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-0 fs-2", children: ((_e = puppy.seller) == null ? void 0 : _e.address) || "Location not available" })
                  ] }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-6 col-md-4 mb-6 border-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex align-items-center gap-2", children: [
            ...
            puppy.characteristics && ((_f = puppy.characteristics) == null ? void 0 : _f.length) > 0 || puppy.features && puppy.features.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-body", children: [
              puppy.characteristics && ((_g = puppy.characteristics) == null ? void 0 : _g.length) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "charlies-characteristics pb-3 border-bottom", children: [
              ...
              puppy.features && ((_h = puppy.features) == null ? void 0 : _h.length) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "charlies-features mt-3 pt-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h5", { className: "mb-3 pb-1 fs-5", children: [
                  puppy.name,
                  "’s Features"
                ] }),
            ...
            ((_i = puppy.seller) == null ? void 0 : _i.is_breeder) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card position-relative overflow-hidden border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-xl-4 d-flex align-items-lg-stretch", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Je, { href: `/breeders/${(_j = puppy.seller) == null ? void 0 : _j.slug}`, className: "trusted-breeders-img position-relative overflow-hidden w-100 text-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "object-fit-cover rounded-circle position-relative overflow-hidden", src: ((_k = puppy.seller) == null ? void 0 : _k.company_logo) ?? "", alt: ((_l = puppy.seller) == null ? void 0 : _l.kennel_name) ?? "company logo", width: "230", height: "230" }) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-xl-8 d-flex align-items-lg-stretch", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "trusted-breeders-details card-body ps-xl-0 pe-4 d-flex align-items-start justify-content-between gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Je, { href: `/breeders/${(_m = puppy.seller) == null ? void 0 : _m.slug}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("h6", { className: "btn-link fs-8 font-work-sans mb-6", children: "Offered By" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "company-details mb-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hstack gap-6 mb-6", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-0", children: ((_n = puppy.seller) == null ? void 0 : _n.kennel_name) || "N/A" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hstack gap-6 mb-6", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-0 fw-medium text-dark", children: "Address:" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-0", children: ((_o = puppy.seller) == null ? void 0 : _o.company_address) || "N/A" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hstack gap-6", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-0", children: ((_p = puppy.seller) == null ? void 0 : _p.company_established_on_label) || "N/A" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Je, { href: `/breeders/${(_q = puppy.seller) == null ? void 0 : _q.slug}`, className: "btn btn-outline-extralight border btn-white text-dark", children: "View More" })
              ] }) }) })
            ] }) })
          ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bringing-through-puppies bg-extralight py-7 py-md-5 py-xl-9", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "d-flex align-items-center justify-content-between mb-4 mb-lg-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mb-0", "data-aos": "fade-right", "data-aos-delay": "100", "data-aos-duration": "1000", children: [
          "Other ",
          (_r = puppy == null ? void 0 : puppy.breeds[0]) == null ? void 0 : _r.name,
          " Listing"
        ] }) }),
