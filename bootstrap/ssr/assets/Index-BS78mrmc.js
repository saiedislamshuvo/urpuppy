...
import { P as PlanCard } from "./PlanCard-Dwa0fAkw.js";
...
const Index = ({ plans, discount }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "subscription-plans pb-0 pb-md-0 py-7 py-md-5 py-xl-9 pb-xl-9", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row mt-8", children: plansList.length > 0 && plansList.map(
      (plan) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-md-6 col-xl-3 mb-7 mb-xl-0 d-flex align-items-stretch", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PlanCard, { discount, plan }) }, plan.id)
    ) }) }) }),
