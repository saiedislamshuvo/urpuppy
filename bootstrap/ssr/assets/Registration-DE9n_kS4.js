import { q, U, r as reactExports, S as Se, j as jsxRuntimeExports, a as je } from "../ssr.js";
...
import { M as MediaUploadSection } from "./MediaUploadSection-BiKe14gO.js";
...
import "./GenericFileUpload-DRmancKi.js";
...
const BreederRegistrationForm = ({ breeds, gallery = [], videos = [], media_limits }) => {
  ...
  const isInitialLoad = U.useRef(true);
  ...
  const { data, setData, post, errors, processing } = Se({
    ...
    gallery: gallery.length > 0 ? gallery : (user == null ? void 0 : user.gallery) ?? [],
    company_logo: null,
    videos: videos.length > 0 ? videos : (user == null ? void 0 : user.video) != null ? [user == null ? void 0 : user.video] : [],
    gmap_payload: null,
