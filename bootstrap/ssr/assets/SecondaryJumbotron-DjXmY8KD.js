...
const SecondaryJumbotron = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-lg-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Je, { href: buttonLink, className: "btn btn-primary mt-4", children: buttonSubtitle })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-lg-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row", children: features.map((feature, index) => {
      var _a, _b, _c, _d;
