  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "footer bg-secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "footer-wrapper pt-7 pt-md-9 pt-lg-10 pb-md-5 pb-lg-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-6 col-md-4 col-lg-2 mb-7 pb-1 pb-lg-0 mb-lg-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "fw-semibold font-work-sans mb-6 text-white", children: "Accounts" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "list-unstyled footer-memu mb-0 mt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Je, { "aria-label": "Buyer Register", href: "/register", className: "fs-3 d-block fw-normal", children: "Buyer Register" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Je, { "aria-label": "Seller Register", href: "/register-seller", className: "fs-3 d-block fw-normal", children: "Seller Register" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Je, { "aria-label": "Breeder Register", href: "/register-breeder", className: "fs-3 d-block fw-normal", children: "Breeder Register" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-6 col-md-4 col-lg-2 mb-7 pb-1 pb-lg-0 mb-lg-0", children: [
...
const AccountDropdownButton = ({ user }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dropdown position-relative user-profile-dropdown", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "dropdown-menu dropdown-menu-end p-3", style: {
      ...
      ((user == null ? void 0 : user.is_seller) || (user == null ? void 0 : user.is_breeder)) && /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Je, { "aria-label": "My Subscription", className: "dropdown-item rounded py-2", href: "/profile", data: {
        tab: "My Subscription"
      }, children: "My Subscriptions" }) }),
      !((user == null ? void 0 : user.is_seller) || (user == null ? void 0 : user.is_breeder)) && /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Je, { "aria-label": "Saved Search", className: "dropdown-item rounded py-2", href: "/profile", data: {
        tab: "Saved Search"
      }, children: "Saved Search" }) }),
      ((user == null ? void 0 : user.is_seller) || (user == null ? void 0 : user.is_breeder)) && /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Je, { "aria-label": "My Puppies", className: "dropdown-item rounded py-2", href: "/profile", data: {
        tab: "My Puppies"
      }, children: "My Puppies" }) }),
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "offcanvas-body pt-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "navbar-nav", children: [
              ...
              (((_b = user == null ? void 0 : user.roles) == null ? void 0 : _b.includes("seller")) || !user) && /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "nav-item", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Je, { "aria-label": "List Ur Puppy", prefetch: true, className: "nav-link text-white", href: "/seller/create", children: "+ List Ur Puppy" }) }),
