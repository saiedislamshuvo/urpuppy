import { j as jsxRuntimeExports, r as reactExports, R as React, S as Se$1 } from "../ssr.js";
import { I as InputError } from "./InputError-BrGvvBAw.js";
import { I as InputLabel } from "./InputLabel-DAgP54zY.js";
import { s as s$2, K, L, y as y$2, n as n$2, o as o$3, a as o$4, b as s$3, u as u$2, t as t$2, T as T$1, l as l$2, p as p$2, f as f$6, F as Fe, c as u$3, z as ze, i as i$2, d as s$4, O as O$3 } from "./transition-Do-OiQ4t.js";
...
function J(e2, l2) {
  ...
  return r2 ? React.createElement(I$1, { ...t2, ownerDocument: u2, ref: o2 }) : a3({ ourProps: { ref: o2 }, theirProps: t2, slot: {}, defaultTag: M, name: "Portal" });
}
let X = reactExports.Fragment, H = reactExports.createContext(null);
function k$1(e2, l2) {
  let { target: o2, ...r2 } = e2, t2 = { ref: y$2(l2) }, a3 = L();
  return React.createElement(H.Provider, { value: o2 }, a3({ ourProps: t2, theirProps: r2, defaultTag: X, name: "Popover.Group" }));
}
...
function $(o2, e2) {
  ...
  return React.createElement(React.Fragment, null, v && React.createElement(f$5, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: g2, features: s$1.Focusable }), B2({ ourProps: k2, theirProps: f2, defaultTag: Z, name: "FocusTrap" }), v && React.createElement(f$5, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: g2, features: s$1.Focusable }));
}
...
let V = K(function(t2, o2) {
  ...
  let le$1 = L();
  return React.createElement(s$4, null, React.createElement(l, { force: true }, React.createElement(oe, null, React.createElement(k.Provider, { value: oe$1 }, React.createElement(D$1, { target: T2 }, React.createElement(l, { force: false }, React.createElement(te2, { slot: U2 }, React.createElement(Q, null, React.createElement(ye, { initialFocus: d2, initialFocusFallback: T2, containers: I2, features: y2 }, React.createElement(C, { value: m2 }, le$1({ ourProps: ne, theirProps: h2, slot: U2, defaultTag: Me, features: Ge, visible: g2 === 0, name: "Dialog" })))))))))));
