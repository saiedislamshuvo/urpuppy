...
import { S as SelectFilterInput, M as MobilePicker, B as BreedFilter } from "./BreedFilter-BJk0nsmz.js";
...
const AgeFilter = ({ setAge, range = [0, 18], mobile = false, defaultValue }) => {
  ...
  const [ageRange, setValues] = U.useState(() => {
...
const FilterBox = () => {
  ...
  const renderMobileFilters = U.useCallback(() => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
