declare namespace App.Data {
    ...
    export type BreedData = {
        ...
        slug: string;
        image: string;
        random_breeder_slug: string | null;
    };
    ...
    export type PuppyData = {
        ...
        puppy_traits: Array<App.Data.PuppyTraitData> | null;
        ...
        has_vet_exam: boolean | null;
        has_travel_ready: boolean | null;
        has_delivery_included: boolean | null;
    ...
    export type PuppyEditData = {
        ...
        certificate_type: string | null;
        certificate_document_url: string | null;
        certificate_document: Array<string> | null;
        lat: number | null;
        lng: number | null;
        address: string | null;
        city: string | null;
