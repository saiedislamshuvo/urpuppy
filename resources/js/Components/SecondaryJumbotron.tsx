          ...
          <div className="col-lg-8">
            <div className="row">
              <div className="col-md-4 mb-7 mb-md-0">
                ...
                <h3 className="fs-5 font-work-sans mt-3">Reach Thousands of Buyers</h3>
              ...
              <div className="col-md-4 mb-7 mb-md-0">
                ...
                <h3 className="fs-5 font-work-sans mt-3">Easy-to-Use Tools</h3>
              ...
              <div className="col-md-4">
                ...
                <h3 className="block fs-5 font-work-sans mt-3">Boosted Visibility</h3>
