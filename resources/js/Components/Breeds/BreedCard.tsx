  ...
  return (
    <div className="item" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
      <div className="featured-breeds-item">
        <Link aria-label="View Details" prefetch cacheFor="3m" href={breed.random_breeder_slug ? `/breeders/${breed.random_breeder_slug}` : `/breeds/${breed.slug}`} className="featured-breeds-img mb-3 d-block">
