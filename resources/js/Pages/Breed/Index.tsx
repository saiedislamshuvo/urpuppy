...
const Index = ({ breeds, letter_param = 'A' }: {
  ...
  const heroTitle = settings?.breeds_hero_title || "Siberian Husky: Your Winter Companion";
  const heroBackground = settings?.breeds_hero_background || '/images/breeds-slider/hero-inner-slider-1.jpg';
  const sectionTitle = settings?.breeds_section_title || "Choose your breeds";
  ...
  return (
    <Layout>
      ...
      <BannerSlider slidesPerView={1} children={[
        <SmallBannerWithContent key="1" title={heroTitle} background_image={heroBackground} />,
      ]} />
            ...
            <div className="col-lg-4">
              ...
              <div className="grid-filter" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                <div className="d-flex  justify-content-between">
                  ...
                  <div className="breed d-flex gap-2 align-items-center">
