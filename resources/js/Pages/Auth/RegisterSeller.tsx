          ...
          <div className="card-body p-0">
            <div className="row">
              <div className="col-lg-7 order-last order-lg-first">
                <div className="login-info d-flex flex-column justify-content-center h-100 py-5 px-3 ps-lg-0 position-relative">
              ...
              <div className="col-lg-5 order-first order-lg-last">
                <div
                  ...
                  <div className="p-4 pb-0 position-absolute top-0 end-0">
                    <Link aria-label='logo' href="/"><img src="/images/logos/logo-white.svg" alt='logo' /></Link>
                  </div>
