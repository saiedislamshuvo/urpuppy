...
class InactiveChatNotification extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: "You have an unread message from {$senderName} on Urpuppy.com",
    ...
    public function content(): Content
    {
        ...
        $m = (new MailMessage)
            ...
            ->line("You have an unread message from **{$senderName}** on Urpuppy.com that has been waiting for over an hour.")
            ->line('**Message:**')
            ->line($messagePreview)
